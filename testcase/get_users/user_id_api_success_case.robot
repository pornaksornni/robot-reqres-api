...
Variables    ${CURDIR}/../../resources/test_data/api/user_id_success.yaml

*** Test Cases ***
Scenario1: Users - Get user by id
    [Tags]    api_get    user_id    success
    ...
    user_feature.Verify user id support section    user_detils=${user_details}
